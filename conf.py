...
htmlhelp_basename = 'ProjetoBibliotefastdoc'
...
man_pages = [
    (master_doc, 'projetobibliotefast', 'Projeto Bibliotefast Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ProjetoBibliotefast', 'Projeto Bibliotefast Documentation',
     author, 'ProjetoBibliotefast', 'One line description of project.',
     'Miscellaneous'),
]
